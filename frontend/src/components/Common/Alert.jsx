    ...
    <div className={`border rounded-lg p-4 ${variantClasses[variant]} ${className}`} role="alert">
      <div className="flex">
        ...
        {dismissible && (
          <button
            onClick={handleClose}
            className="flex-shrink-0 mr-auto -mt-1 -ml-1 inline-flex text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 rounded-lg p-1.5"
          >
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
